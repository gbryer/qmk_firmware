...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN] = LAYOUT(
            ...
            KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  KC_FUNCTION(KC_SPC),  KC_SPC,           KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT,   KC_END
    ),
    ...
    [_GAMING] = LAYOUT(
            ...
            KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  KC_FUNCTION(KC_F15),  KC_SPC,           KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT,   KC_END
    ),
    ...
    [_FUNCTION] = LAYOUT(
            ...
            _______, _______, _______, _______, _______, _______, KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT, _______, _______,          KC_LOCK,
            _______, _______, _______, _______, _______, _______, _______, _______, KC_SELECT_WORD, BL_DEC, BL_INC, _______, _______, _______,
            _______, _______, _______,                   _______, _______, _______,          KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT, KC_MPLY
    ),
